...
class DrawerSuperior:

    def deteccion_etiquetas():
        ...
        discos_fru = cv2.CascadeClassifier('discos.xml')
        img = cv2.imread('disco.png')
        ...
        discosfru = discos_fru.detectMultiScale(gray, scaleFactor=1.03, minNeighbors=4, minSize=(5, 5), flags=cv2.CASCADE_SCALE_IMAGE)
